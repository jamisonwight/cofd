export default {
    ...
    image_container: `animate-gradient-bg z-[3]`,
    image: `relative w-full h-full p-[10px] object-cover z-[3]`,
    image_width: `w-[300px] md:w-[420px] lg:w-[420px]`,
    image_height: `h-[200px] md:h-[320px] lg:h-[320px]`,
    content: `relative w-full lg:w-[calc(100%_-_600px)] -lg:my-[40px]`,
    content_full: `relative flex-col text-center mb-[60px] z-[3]`,
    image_full: `relative animate-gradient-bg z-[3]`,
    image_full_width: `md:w-[588px] lg:w-[688px]`,
    image_full_height: `md:h-[382px] lg:h-[382px]`,
